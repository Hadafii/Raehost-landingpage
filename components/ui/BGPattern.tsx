...
const maskClasses: Record<BGMaskType, string> = {
  ...
  "fade-top":
    "[mask-image:linear-gradient(to_bottom,transparent_0%,black_70%)]",
  "fade-bottom":
    "[mask-image:linear-gradient(to_bottom,black_70%,transparent_100%)]",
  "fade-left":
    "[mask-image:linear-gradient(to_right,transparent_0%,black_70%)]",
  "fade-right":
    "[mask-image:linear-gradient(to_right,black_70%,transparent_100%)]",
  "fade-x":
    "[mask-image:linear-gradient(to_right,transparent_0%,black_70%,transparent_100%)]",
  "fade-y":
    "[mask-image:linear-gradient(to_bottom,transparent_0%,black_70%,transparent_100%)]",
  none: "",
};
